...
define void @core_2_3() {
  ...
  store i32 4, ptr getelementptr inbounds nuw (i8, ptr @out_cons_buff_0, i64 4), align 4
  br label %1
...
4:                                                ; preds = %1
  %5 = getelementptr inbounds nuw i32, ptr @out_cons_buff_0, i64 %2
  %6 = load i32, ptr %5, align 4
  %7 = getelementptr inbounds nuw i32, ptr @back_buff_0, i64 %2
  store i32 %6, ptr %7, align 4
  %8 = add i64 %2, 1
  br label %1

9:                                                ; preds = %1
  store i32 3, ptr getelementptr inbounds nuw (i8, ptr @back_buff_0, i64 24), align 4
...
define void @core_1_1() {
  ...
  store i32 5, ptr getelementptr inbounds nuw (i8, ptr @out_buff_0, i64 8), align 4
  call void @llvm.aie.lock.release.reg(i32 48, i32 1)
  call void @llvm.aie.lock.acquire.reg(i32 49, i32 1)
  store i32 9, ptr getelementptr inbounds nuw (i8, ptr @back_cons_buff_0, i64 20), align 4
